...
<?php if ($news->have_posts()) : while ($news->have_posts()) : $news->the_post(); ?>
    ...
    <section class="news__introduction" style="background-image: url(<?= $fields['actu_branding']; ?>);">
        <div class="title">
            <h2><?= $fields['actu_title']; ?></h2>
        </div>
    </section>
    <?php if ($fields['actu_date'] || $fields['actu_hour'] || $fields['actu_address']) : ?>
    ...
    <h2 class="u-hidden-visually">Présentation d'image de <?= $fields['actu_title']; ?></h2>
        <?php $images = get_field('actu_gallery');
        if ($images) : ?>
