    ...
    <?php if (have_rows('artist_location')) : the_row(); ?>
        <div class="location">
            <a title="Vers la google map ci-dessous" href="#map">
                <address itemprop="workLocation">
                    <?php the_sub_field('artist_address'); ?>
                </address>
            </a>
        </div>
    <?php endif; ?>
    <a title="Vers la section suivante ci-dessous" href="#next" class="demo" id="next">
        <span></span>
        Scroll
    </a>
</section>
<?php if (have_rows('section_description')) : while (have_rows('section_description')) : the_row(); ?>
    <section class="description">
        ...
        <div>
            <h3 itemprop="additionalName"><?= $fields['artist_surname']; ?> <?= $fields['artist_name']; ?></h3>
            ...
            <?php foreach (sla_taxonomies(get_the_ID(), 'kind') as $taxo) : ?>
                <p>#<span itemprop="jobTitle"><?= $taxo; ?></span></p>
            <?php endforeach; ?>  
            </div>
            <a title="Vers la page tous nos artistes"href="<?= get_the_permalink('236') ;?>" class="btn btn--anim"  data-text="Voir tous nos artistes">Voir tous nos artistes</a>
        </div>
    </section>
<?php endwhile;
endif; ?>
...
<section class="social">
    ...
    <div>
        <a title="Vers la page twitter de <?= $fields['artist_surname'] ;?>" itemprop="follows" href="<?php the_sub_field('social_twitter'); ?>">
        ...
        <a title="Vers la page facebook de <?= $fields['artist_surname']; ?>" itemprop="follows" href="<?php the_sub_field('social_facebook'); ?>" class="">
        ...
        <a title="Vers la page instagram de <?= $fields['artist_surname']; ?>" itemprop="follows" href="<?php the_sub_field('social_instagram'); ?>">
