...
<section class="social">
    ...
    <div>
        <a itemprop="follows" href="<?php the_sub_field('social_twitter'); ?>">
        ...
        <a itemprop="follows" href="<?php the_sub_field('social_facebook'); ?>" class="">
        ...
        <a itemprop="follows" href="<?php the_sub_field('social_instagram'); ?>">
